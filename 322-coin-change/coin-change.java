...
class Solution {
    ...
    public int countOfSubSetSum(int coins[], int sum,int n){
        
        int t[][] = new int[n+1][sum+1];
        
        for(int i=0;i<n+1;i++){
            
            t[i][0] = 0;//because 0 sum every sixe of arr mai rahega so 1 way ho jayaga 
        ...
        if(t[n][sum] >= Integer.MAX_VALUE-2){
            return -1;
        }
    ...
    public int coinChange(int coins[], int amount ) {
        ...
        return countOfSubSetSum(coins,  amount , n);
    }
}
